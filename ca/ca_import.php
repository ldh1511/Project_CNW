...
<?php include(ROOT_PATH . "/controllers/ca.php");
adminOnly();
?>
<!doctype html>
<html lang="en">
    ...
    <div class="main-container">
        <div class="content-box-admin">
            ...
            <div class="content-right admin-container">
                <!--  resume -->
                <div class="title-box">
                    <h3 class="admin-title">Import certificate</h3>
                ...
                <form action="ca_import.php" method="post" class="form-manage form-import" enctype="multipart/form-data">
                    <?php include(ROOT_PATH . "/helper/formErrors.php") ?>
                    <div class="form-group">
                        <label for="Import"></label>
                        <input type="file" name="file" />
                    </div>
                    <button class="btn btn-primary btn-manage" name="ca_preview">Preview</button>
                </form>
