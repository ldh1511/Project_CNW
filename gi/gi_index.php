    ...
    <div class="main-container">
        <div class="content-box-admin">
            ...
            <div class="content-right admin-container">
                <!--  resume -->
                <div class="title-box">
                    <h3 class="admin-title">Team's Information</h3>
                ...
                <div class="container">
                    ...
                    <div class="row  p-0 m-0">
                        <div class="form-group flex-grow-1 mr-2">
                            ...
                            <input type="text" name="price" id="" class="form-control input-read" aria-describedby="helpId" value="<?php echo $gi_address ?>" disabled>
                        </div>
                        <div class="form-group flex-grow-1">
                            <label for="">Email</label>
                            <input type="text" name="price" id="" class="form-control input-read" aria-describedby="helpId" value="<?php echo $gi_email ?>"" disabled>
                        </div>
                    </div>
                    <div class=" form-group">
                            <label for="">Intro</label>
                            <textarea type="text" name="service_description" id="" class="form-control input-read" aria-describedby="helpId" disabled><?php echo $gi_intro ?></textarea>
                        </div>
                        <a href="gi_edit.php?edit_id=<?php echo $gi_id ?>"><i class="far fa-edit h5"></i></a>
                        ...
                        <div class="form-group">
                            ...
                            <div class="banner">
                                <img src="<?php echo '../Img/' . $gi_bg ?>" alt="" id="avatar-img" class="banner_gi">
                            </div>
                        </div>
                    </div>
                </div>
